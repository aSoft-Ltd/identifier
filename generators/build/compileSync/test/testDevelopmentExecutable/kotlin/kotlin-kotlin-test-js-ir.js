(function (root, factory) {
  ...
  function assertNotNull_0(actual, message) {
    ...
    get_asserter().assertNotNull_wuch1g_k$(message, actual);
    return ensureNotNull(actual);
  }
  function assertNotNull$default(actual, message, $mask0, $handler) {
    if (!(($mask0 & 2) === 0))
      message = null;
    return assertNotNull_0(actual, message);
  }
  function assertNull_0(actual, message) {
    get_asserter().assertNull_e5yf43_k$(message, actual);
  }
  function assertNull$default(actual, message, $mask0, $handler) {
    if (!(($mask0 & 2) === 0))
      message = null;
    return assertNull_0(actual, message);
  }
  ...
  _.$_$.b = assertNotNull$default;
  _.$_$.c = assertNull$default;
  _.$_$.d = assertEquals_0;
  _.$_$.e = assertNotNull_0;
  _.$_$.f = assertNull_0;
  _.$_$.g = assertTrue_1;
  _.$_$.h = suite;
  _.$_$.i = test;
